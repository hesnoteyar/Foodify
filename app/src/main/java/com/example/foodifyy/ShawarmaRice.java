...
public class ShawarmaRice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shawarma_rice);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("food").child("FOOD004");
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                h.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(ShawarmaRice.this, mainscreen.class);
                        startActivity(i);
                    }
                }, 0);
            }
    ...
    private void addToCart() {
        if (auth.getCurrentUser() != null) {
            ...
            Toast.makeText(ShawarmaRice.this, "Added to Cart", Toast.LENGTH_SHORT).show();
        }
    }
