...
public class Siomai extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_siomai);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("food").child("FOOD002");
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                h.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(Siomai.this, mainscreen.class);
                        startActivity(i);
                    }
                }, 0);
            }
    ...
    private void addToCart() {
        if (auth.getCurrentUser() != null) {
            ...
            Toast.makeText(Siomai.this, "Added to Cart", Toast.LENGTH_SHORT).show();
        }
    }
